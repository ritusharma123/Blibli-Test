...
struct MaterialRefreshConfig: MateriallBackendAPIObjectResponse, MateriallBackendAPIURLEncodedRequest {
    ...
    var endpoint: String {
        var urlEndPoint = "api/configuration/refresh"
